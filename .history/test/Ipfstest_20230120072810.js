...
const web3 = new Web3(givenProvider || 'http://localhost:7545');
const Tree = TruffleContract(require('../build/contracts/Tree.json'));
Tree.setProvider(web3.currentProvider);
